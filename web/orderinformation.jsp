                ...
                <div class="main-section-content">
                    ...
                    <div class="orderdetails-content">
                        <div class="id-status-order">
                            <span class="id-order">ID đơn hàng: ${order.order_id} &nbsp;&nbsp;|</span>
                            <span class="status-order">Trạng thái đơn hàng: ${order.setting.value}</span>
                        </div>
                            ...
                            <div class="products-container">
                                ...
                                <div class="right-container">
                                    <div class="product-price">
                                        ...
                                        <c:if test="${order.setting.value=='Đã nhận'}">
                                        <div class="feedback-item">
                                            <button class="btn-feedback" onclick="window.location = './SendFeedback?pid=${o.product_id}'">Phản hồi</button>
                                        </div>
                                    </c:if>
                                </div>
                        ...
                        <div class="info-container">
                            <div class="order-info">
                                <div class="deliadd">Địa chỉ giao hàng</div>
                                <div class="fullname">Họ và tên: ${order.fullname}</div>
                                <div class="address-order">
                                    Số điện thoại:${order.phone}<br>Địa chỉ:${order.address}
                                </div>
                            </div>
                            <div class="div-right">
                                ...
                                <div class="total-prices">Tổng giá: &nbsp;&nbsp;&nbsp; <span class="bottoms">${order.total}$</span></div>
                            </div>
                        </div>
                        <c:if test="${order.setting.value=='Đang chờ'}">
                            <div class="info-container">
                                <h3 style="text-align: center ;color: yellow">Quét mã Qr này đẻ thanh toán:</h3>
                                <img src="./images/QR.png" alt="alt"/>
                            </div>
                        </c:if>
                    </div>
                </div>
