                        ...
                        <div class="filter">
                            <form action="ProductList" name="frm-refine" method="get">
                                ...
                                <div class="right">
                                    ...
                                    <select name="orderby">
                                        <option  ${requestScope.orderby==1?"selected":""} value="1" >Theo ngày</option>
                                        <option  ${requestScope.orderby==2?"selected":""} value="2">Theo giá tăng dần</option>
                                        <option  ${requestScope.orderby==3?"selected":""} value="3">Theo giá giảm dần</option>
                                    </select>
