...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left" style="height: 100%;">
                                    ...
                                    <form action="productmanagement?action=edit" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="number" step="0.01" min="1" max="1000000" name="price" required value="${s.price}">

                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Giá bán:</label>
                                                <input class="form-control" type="number" step="0.01" min="1" max="1000000"name="salePrice" required value="${s.salePrice}">

                                            </div>

                                            <div class="form-group col-md-6">
                                                <label class="control-label">Tồn kho:</label>
                                                <input class="form-control" type="number" name="stock" min="1" max="1000000" required value="${s.stock}">
                                            </div>
                                            <div class="form-group col-md-6">
            ...
            <script>
                CKEDITOR.replace('editoredit${s.id}');
            </script>
            <script>
